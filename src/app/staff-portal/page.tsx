    ...
    <main data-role="teacher" style={{ minHeight: '100vh', padding: '2rem', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem', position: 'relative', zIndex: 1 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <div style={{ width: '40px', height: '40px', borderRadius: 'var(--radius-md)', background: 'var(--gradient-teacher)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.1rem' }}>👩‍🏫</div>
          <div>
      ...
      <div className="glass-card animate-fade-in" style={{ maxWidth: '800px', margin: '0 auto', padding: '3rem', textAlign: 'center', position: 'relative', zIndex: 1 }}>
        ...
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, marginBottom: '1.5rem' }}>
          Hi <strong>{user.name}</strong>! Your teaching assistant is ready. Try asking:<br />
          <em style={{ color: '#06b6d4' }}>"Mark Rahul absent today."</em>
        </p>
        <div style={{ display: 'inline-block', background: 'rgba(6,182,212,0.1)', border: '1px solid rgba(6,182,212,0.3)', borderRadius: 'var(--radius-md)', padding: '0.75rem 1.5rem', color: '#22d3ee', fontSize: '0.9rem' }}>
